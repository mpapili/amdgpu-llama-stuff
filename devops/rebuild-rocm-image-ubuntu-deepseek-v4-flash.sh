...
# Rebuilds with tag ubuntu-llama-cpp-deepseek-v4-flash:latest
...
IMAGE_TAG="ubuntu-llama-cpp-deepseek-v4-flash:latest"
DOCKERFILE="Dockerfile.ubuntu-rocm-deepseek-v4-flash"
