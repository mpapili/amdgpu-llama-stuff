...
# Deletes the old image, clears builder cache, and rebuilds with tag fedora-llama-cpp-vulkan:latest
...
IMAGE_TAG="fedora-llama-cpp-vulkan:latest"
DOCKERFILE="Dockerfile.fedora-vulkan"
